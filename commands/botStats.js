...
module.exports = {
    ...
    async execute (interaction, client) {
        ...
        const statsEmbed = new MessageEmbed()
            ...
            .addFields({name: "🔹 General stats", value: `**Current up time:** ${moment(moment.duration(client.uptime, 'milliseconds').as('milliseconds')).format('DD [days] HH [hours] mm [minutes and] ss [seconds]', {trim: true})}\n**Worships sent:** ${client.botStats.worshipsNum}\n**Total commands used:** ${client.botStats.commandCount}`},
